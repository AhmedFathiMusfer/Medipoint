...
part of 'changePassword.state.dart';
...
@override
String toString() {
  return 'ChangePasswordState.initial(loading: $loading)';
}
...
/// @nodoc
abstract mixin class _$InitialCopyWith<$Res> implements $ChangePasswordStateCopyWith<$Res> {
